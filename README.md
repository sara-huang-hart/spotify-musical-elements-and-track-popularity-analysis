...
To improve this project, I would collect additional data on the genre and the release period of each track. Analyzing this data in subsets based on genre or historical period could yield more accurate results since music can vary significantly across these factors.  
